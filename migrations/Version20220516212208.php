 ...
 */
final class Version20220516212208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP nom');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD nom VARCHAR(255) DEFAULT NULL');
